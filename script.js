...
function getWeatherDetails(name, lat, lon, country, state) {
    ...
    fetch(WEATHER_API_URL)
        ...
        .then(data => {
            ...
            {speed} = data.wind,
            sRiseTime = moment.utc(sunrise, 'X').add().add(timezone, 'seconds').format('hh:mm A'),
            sSetTime = moment.utc(sunset, 'X').add().add(timezone, 'seconds').format('hh:mm A');
                ...
                fiveDaysForecastCard.innerHTML += `
                    <div class="forecast-item">
                        <div class="icon-wrapper">
                            <img src="https://openweathermap.org/img/wn/${fiveDaysForecast[i].
                                weather[0].icon}.png" 
                            alt="">
